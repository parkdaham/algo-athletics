...
const HomePage = () => {
    ...
    return (
        <div className="relative flex flex-col"
                ...
                <div className="box-border content-stretch flex flex-col gap-6 items-center justify-start p-0 relative w-full">
                    ...
                    <div className="relative shrink-0 w-full" data-name="section_summary">
                        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative w-full">
                            ...
                            {/* "오늘은 회복력 중심 루틴" 섹션 */}
                            <Link to="/weekly-routine-detail" className="relative w-full cursor-pointer transition-all duration-200" data-name="Block/Chevron content button">
                                <div className="flex flex-row items-center overflow-clip size-full bg-[#fefefe] rounded-xl">
            ...
            <div className="flex-grow w-full bg-[#fefefe] shadow-[0px_-4px_16px_0px_rgba(21,21,21,0.12)] rounded-tl-[24px] rounded-tr-[24px] pt-3"
                        ...
                        <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-0 relative w-full">
                            ...
                            <div className="w-full">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div 
                                        className="bg-gray-50 relative rounded-xl shrink-0 w-full py-5 cursor-pointer transition-all duration-200"
                            ...
                            {/* 훈련 후 시간대 섹션 */}
                            <div className="w-full">
                                <h2 className="text-xl font-bold text-gray-800 mb-4">훈련 전</h2>
                                <div className="space-y-3">
                                    {/* 훈련 전 루틴 카드 */}
                                    <div 
                                        className={`bg-[#fefefe] relative rounded-xl shrink-0 w-full py-5 cursor-pointer transition-all duration-200 border border-gray-200 ${routineStates.beforeWorkout ? 'opacity-75' : ''} mt-4`}
                            ...
                            {/* 훈련 전 시간대 섹션 */}
                            <div className="w-full">
                                <h2 className="text-xl font-bold text-gray-800 mb-4">훈련 후</h2>
                                <div className="space-y-3">
                                       {/* 훈련 후 루틴 카드 */}
                                       <div 
                                        className={`bg-[#fefefe] relative rounded-xl shrink-0 w-full py-5 cursor-pointer transition-all duration-200 border border-gray-200 ${routineStates.afterWorkout ? 'opacity-75' : ''} mt-4`}
                            ...
                            <div className="w-full">
                                ...
                                <div className="space-y-3">
                                    {/* 자기 전 루틴 카드 */}
                                    <div 
                                        className={`bg-[#fefefe] relative rounded-xl shrink-0 w-full py-5 cursor-pointer transition-all duration-200 border border-gray-200 ${routineStates.bedtime ? 'opacity-75' : ''} mt-4`}
